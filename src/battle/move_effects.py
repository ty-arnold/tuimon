...
def apply_move_effect(
    ...
    match effect.effect_type:
        case "protect":
            return handle_protect_effect(effect, attacker, current_turn, events=events)
        case "screen":
            return handle_screen_effect(effect, target, current_turn, events=events)
        case "mist":
            return handle_mist_effect(effect, target, current_turn, events=events)
        case _:
